...
def load_artifacts():
    ...
    return model, scaler, label_encoder, categorical_encoders, numeric_cols_order, categorical_cols_order

model, scaler, label_encoder, categorical_encoders, app_numeric_cols, app_categorical_cols = load_artifacts()

# Combine all feature columns in the exact order used during training for the model input
all_feature_columns_order = app_numeric_cols + app_categorical_cols
